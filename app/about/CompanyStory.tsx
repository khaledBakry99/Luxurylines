...
export default function CompanyStory() {
  ...
  return (
    <section
      id="company-story"
      ref={sectionRef}
      className="py-20 bg-gradient-to-b from-[#0A2F33] to-[#0F3A3E] relative overflow-hidden"
    >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-3xl mx-auto">
              رحلة من الشغف والإبداع بدأت منذ عقد ونصف، لتصبح اليوم أحد أبرز
              الأسماء في عالم التصميم والتشطيب
            </p>
          </div>
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-white/80 leading-relaxed">
                  بدأت رحلتنا في عام 2023 بحلم بسيط: تحويل المساحات العادية إلى
                  تحف معمارية تعكس شخصية أصحابها وتلبي احتياجاتهم. منذ ذلك
                  الحين، نمونا لنصبح فريقاً من 50+ مهندس ومصمم متخصص.
                </p>

                <p className="text-white/80 leading-relaxed">
                  نؤمن بأن التصميم الجيد ليس مجرد شكل جميل، بل هو حل ذكي يجمع
                  بين الوظيفة والجمال والاستدامة. هذا ما دفعنا لتطوير منهجية عمل
                  فريدة تضمن تحقيق رؤية كل عميل بأعلى معايير الجودة.
                </p>

                <div className="bg-gradient-to-r from-[#CBC1B8]/10 to-[#F7F6F4]/10 p-6 rounded-2xl border-r-4 border-[#CBC1B8]">
                  <h4 className="text-xl font-bold text-white mb-3 font-['Cairo']">
                    رؤيتنا
                  </h4>
                  <p className="text-white/80">
                    أن نكون الخيار الأول في المملكة العربية السعودية للتصميم
                    الداخلي والخارجي الفاخر، ونساهم في تشكيل مستقبل العمارة
                    المعاصرة.
                  </p>
                </div>
              </div>
                  ...
                  >
                    <div className="flex items-center space-x-3 space-x-reverse">
                      <div className="w-12 h-12 bg-gradient-to-r from-[#CBC1B8] to-[#F7F6F4] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                        <i
                          className={`${achievement.icon} text-[#0A1F21] text-xl`}
                        ></i>
                      </div>
                      <div>
                        <div className="text-xl font-bold text-white font-['Cairo']">
                          {achievement.count}
                        </div>
