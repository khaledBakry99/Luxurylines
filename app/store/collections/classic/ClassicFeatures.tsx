...
export default function ClassicFeatures() {
  const features = [
    {
      icon: 'ri-hand-heart-line',
      title: 'صناعة يدوية',
      description: 'كل قطعة منحوتة بعناية فائقة من قبل حرفيين مهرة'
    },
    {
      icon: 'ri-vip-crown-line',
      title: 'خامات فاخرة',
      description: 'أجود أنواع الخشب والأقمشة والتطعيمات الذهبية'
    },
    {
      icon: 'ri-time-line',
      title: 'تصاميم خالدة',
      description: 'أناقة كلاسيكية لا تتأثر بتغير الموضة'
    },
    {
      icon: 'ri-award-line',
      title: 'ضمان الجودة',
      description: 'ضمان شامل على جميع المنتجات الكلاسيكية'
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-[#001F3F] mb-6">
            لماذا تختار مجموعتنا الكلاسيكية؟
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            تميز بالفخامة والأصالة مع قطع فنية تعكس الذوق الرفيع
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#001F3F] to-[#003366] rounded-3xl p-12 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
            نصائح مجانية لاختيار القطع المناسبة
          </h3>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            خبراؤنا جاهزون لمساعدتك في تنسيق مساحتك بأسلوب كلاسيكي فاخر
          </p>
