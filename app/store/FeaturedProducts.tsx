...
const products = [
  ...
  },
  {
    ...
    reviews: 156,
    image:
      "https://readdy.ai/api/search-image?query=luxury%20marble%20dining%20table%20with%20elegant%20white%20and%20gold%20veined%20marble%20top%20modern%20metal%20base%20contemporary%20design%20on%20clean%20white%20background%20professional%20product%20photography&width=600&height=600&seq=prod-table-1&orientation=squarish",
    badge: "خصم 15%",
  ...
  },
  {
    ...
    reviews: 94,
    image:
      "https://readdy.ai/api/search-image?query=luxury%20decorative%20wall%20mirror%20with%20elegant%20gold%20metallic%20frame%20ornate%20design%20sophisticated%20details%20on%20clean%20white%20background%20professional%20product%20photography&width=600&height=600&seq=prod-mirror-1&orientation=squarish",
    badge: null,
    badgeColor: "",
  },
  {
...
export default function FeaturedProducts() {
  ...
  return (
    <section
      id="products"
      className="py-20 bg-gradient-to-b from-[#1C474A] to-[#0A2F33] relative"
    >
          ...
          {products.map((product, index) => (
            <div
              ...
              style={{
                ...
                opacity: 0,
                boxShadow:
                  "0 4px 20px rgba(203, 193, 184, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
              }}
            >
              <div className="relative h-80 overflow-hidden bg-[#0A1F21]/30">
                ...
                {product.badge && (
                  <div
                    className={`absolute top-4 right-4 px-4 py-2 ${product.badgeColor} text-white text-sm font-semibold rounded-full shadow-lg`}
                  >
                    {product.badge}
                  </div>
                )}
              ...
              <div className="p-6">
                <div className="text-sm text-[#CBC1B8] font-semibold mb-2">
                  {product.category}
                </div>
      ...
      <div className="absolute inset-0 bg-[#0A1F21]/95 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="text-center px-6">
          ...
          <p className="text-xl text-[#CBC1B8] mb-8 max-w-2xl mx-auto">
            نعمل حالياً على إضافة منتجاتنا المميزة لتقديم أفضل تجربة تسوق
          </p>
      ...
      <style jsx>{`
        ...
        [data-product-shop] > div:hover {
          box-shadow: 0 8px 32px rgba(203, 193, 184, 0.25),
