          ...
          {[
            ...
            >
              <div
                ...
                style={{
                  background: `linear-gradient(to right, transparent, ${
                    contact.gradient.includes("25D366") ? "#25D366" : "#CBC1B8"
                  }, transparent)`,
                }}
              ></div>
              ...
              <div className="relative z-10 text-center">
                <div
                  className={`w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-gradient-to-br ${contact.gradient} rounded-2xl shadow-lg transform group-hover:rotate-6 group-hover:scale-110 transition-all duration-500`}
                >
                ...
                <p
                  ...
                  dir={
                    contact.desc.includes("+966") || contact.desc.includes("@")
                      ? "ltr"
                      : "rtl"
                  }
                >
              ...
              <div
                className={`absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-br ${contact.gradient} opacity-5 rounded-full group-hover:scale-150 group-hover:opacity-10 transition-all duration-700`}
              ></div>
            </a>
          ))}
        </div>
