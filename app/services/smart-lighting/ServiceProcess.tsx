...
export default function ServiceProcess() {
  const steps = [
    ...
    },
    {
      ...
      description: "نضع خطة شاملة لنظام الإضاءة الذكية المناسب",
    },
    {
      number: "03",
      icon: "ri-shopping-cart-line",
      title: "اختيار المعدات",
      description: "نختار أفضل أنواع المصابيح والأجهزة الذكية",
    },
    {
      number: "04",
      icon: "ri-tools-line",
      title: "التركيب والتوصيل",
      description: "نقوم بتركيب النظام بشكل احترافي ومنظم",
    },
    {
      number: "05",
      icon: "ri-settings-3-line",
      title: "الإعداد والبرمجة",
      description: "نبرمج النظام ونضبط الإعدادات حسب رغبتك",
    },
    {
      number: "06",
      icon: "ri-user-settings-line",
      title: "التدريب والتسليم",
      description: "ندربك على استخدام النظام ونقدم الدعم",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-3xl shadow-lg hover:shadow-2xl hover:bg-white/15 transition-all duration-500 transform hover:-translate-y-2">
