...
export default function ServiceProcess() {
  const steps = [
    ...
    },
    {
      ...
      description: "نصمم حمامك بتقنية 3D لرؤية كل التفاصيل",
    },
    {
      number: "03",
      icon: "ri-shopping-cart-line",
      title: "اختيار المواد",
      description: "نساعدك في اختيار أفضل الخامات والأدوات الصحية",
    },
    {
      number: "04",
      icon: "ri-hammer-line",
      title: "أعمال السباكة",
      description: "نقوم بأعمال السباكة بأحدث الأنظمة العالمية",
    },
    {
      number: "05",
      icon: "ri-tools-line",
      title: "التركيب والتشطيب",
      description: "نركب جميع العناصر ونشطب الحمام بدقة عالية",
    },
    {
      number: "06",
      icon: "ri-checkbox-circle-line",
      title: "الفحص والتسليم",
      description: "نفحص ونختبر كل شيء قبل التسليم",
    },
  ];
