      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#CBC1B8]/10 to-[#F7F6F4]/10 backdrop-blur-sm border border-[#CBC1B8]/20 rounded-full mb-6">
            ...
            <span className="text-[#CBC1B8] font-semibold">احصل على نصائح مجانية من خبرائنا</span>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="" className="bg-[#0A1F21] text-white">اختر نوع الخدمة</option>
                    <option value="interior" className="bg-[#0A1F21] text-white">التصميم الداخلي</option>
                    <option value="exterior" className="bg-[#0A1F21] text-white">التصميم الخارجي</option>
                    <option value="finishing" className="bg-[#0A1F21] text-white">التشطيبات</option>
                    <option value="supply" className="bg-[#0A1F21] text-white">التوريد</option>
                    <option value="management" className="bg-[#0A1F21] text-white">إدارة المشاريع</option>
                  </select>
            ...
            <div className="mb-8 group">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-6 py-4 bg-white/10 border-2 border-white/20 rounded-2xl text-white text-sm focus:outline-none focus:border-[#CBC1B8] focus:bg-white/15 transition-all duration-300 appearance-none cursor-pointer group-hover:border-[#CBC1B8]/30 pr-8"
                >
                  <option value="" className="bg-[#0A1F21] text-white">اختر الميزانية المتوقعة</option>
                  <option value="50k-100k" className="bg-[#0A1F21] text-white">50,000 - 100,000 ريال</option>
                  <option value="100k-250k" className="bg-[#0A1F21] text-white">100,000 - 250,000 ريال</option>
                  <option value="250k-500k" className="bg-[#0A1F21] text-white">250,000 - 500,000 ريال</option>
                  <option value="500k+" className="bg-[#0A1F21] text-white">أكثر من 500,000 ريال</option>
                </select>
                <i className="ri-arrow-down-s-line absolute left-4 top-1/2 transform -translate-y-1/2 text-[#CBC1B8] text-xl pointer-events-none"></i>
              </div>
            </div>
            ...
            <div className="mb-8 group">
              ...
              <div className="flex justify-between items-center mt-2">
                <p className="text-sm text-white/60">الرجاء تحديد الرسالة بـ 500 حرف كحد أقصى</p>
                <p className={`text-sm font-semibold ${charCount > 500 ? 'text-red-500' : 'text-[#CBC1B8]'}`}>
                  {charCount}/500 حرف
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              <label className="flex items-start cursor-pointer group">
                ...
                <span className="text-white/80 text-sm leading-relaxed group-hover:text-white transition-colors">
                  أوافق على سياسة الخصوصية وأوافق على تلقي اتصالات تسويقية من لوكس لين
                </span>
              </label>
            </div>
        ...
        {/* معلومات إضافية */}
        <div className={`max-w-4xl mx-auto mt-16 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="bg-gradient-to-br from-[#0A1F21] to-[#0F3A3E] rounded-3xl p-10 text-center shadow-2xl border border-[#CBC1B8]/20">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">هل لديك استفسار حول النصائح؟</h3>
            <p className="text-white/80 text-lg mb-8">فريق خدمة العملاء لدينا جاهز لمساعدتك في أي وقت</p>
