  ...
  const packages = [
    {
      ...
      price: '35,000',
      description: 'مثالية للمطابخ الصغيرة والمتوسطة',
      features: [
        'تصميم ثلاثي الأبعاد',
        'خزائن عالية الجودة',
        'سطح عمل متين',
    ...
    },
    {
      ...
      price: '70,000',
      description: 'الأكثر طلباً للمطابخ العصرية',
      features: [
        'كل مميزات الباقة الأساسية',
        'أجهزة كهربائية متطورة',
        'سطح عمل رخامي',
        'جزيرة مطبخ',
        'تخزين ذكي',
    ...
    },
    {
      name: 'الباقة الفاخرة',
      price: '150,000',
      description: 'للمطابخ الفاخرة والفلل الراقية',
      features: [
        'كل مميزات الباقة المتقدمة',
        'أجهزة عالمية فاخرة',
        'سطح عمل من الجرانيت الفاخر',
        'جزيرة مطبخ كبيرة',
        'نظام تخزين متكامل',
        'إضاءة ذكية',
        'تصميم مخصص بالكامل',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {packages.map((pkg, index) => (
            <div 
              key={index}
              className={`relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 ${pkg.popular ? 'ring-4 ring-slate-600 scale-105' : ''}`}
            >
              {pkg.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-gradient-to-r from-[#0F3A3E] to-[#0A2F33] text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg whitespace-nowrap">
                    الأكثر طلباً
                  </span>
                </div>
              )}
