    ...
    <footer className="bg-[#0A1F21] text-[#F7F6F4]">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="font-['Cairo'] text-xl font-bold mb-4 text-[#CBC1B8]">
              Luxurylines
            </h3>
            <p className="text-[#CBC1B8]/80 mb-4 leading-relaxed">
              متجر ومعرض خدمات متكامل للتصميم الداخلي والخارجي، التشطيب، وتعهد
              المشاريع
            </p>
            <div className="flex space-x-4 space-x-reverse">
              <Link
                href="#"
                className="w-10 h-10 flex items-center justify-center bg-[#CBC1B8] rounded-full hover:bg-[#F7F6F4] transition-colors cursor-pointer"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-['Cairo'] text-lg font-semibold mb-4 text-[#CBC1B8]">
              روابط سريعة
            </h4>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="group relative inline-block text-[#F7F6F4]/80 hover:text-[#CBC1B8] transition-colors cursor-pointer overflow-hidden"
                >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="group relative inline-block text-[#F7F6F4]/80 hover:text-[#CBC1B8] transition-colors cursor-pointer overflow-hidden"
                >
                  <span className="relative z-10">توريد مواد البناء</span>
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#CBC1B8] group-hover:w-full transition-all duration-300"></span>
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className="text-[#F7F6F4]/80 hover:text-[#CBC1B8] transition-colors duration-300 flex items-center gap-2 group whitespace-nowrap"
                >
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-[#F7F6F4]/80 text-sm">
                  شارع انس بن مالك - مبنى امازون - الدور الثاني - مكتب رقم ١٥ -
                  حي الصحافه - الرياض - المملكه العربيه السعوديه
                </span>
              </div>
              <div className="flex items-center">
                <div className="w-5 h-5 flex items-center justify-center ml-3">
                ...
                <a
                  ...
                  className="text-[#F7F6F4]/80 hover:text-[#CBC1B8] transition-colors"
                  dir="ltr"
                >
                  +966 55 930 0791
                </a>
        ...
        <div className="border-t border-[#1C474A] mt-8 pt-8">
          <p className="text-[#CBC1B8]/70 text-center">
            © 2026 Luxurylines. جميع الحقوق محفوظة.
          </p>
        </div>
      </div>
    </footer>
