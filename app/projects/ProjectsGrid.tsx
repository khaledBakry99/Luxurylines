...
const allProjects = [
  {
    ...
    duration: "8 أشهر",
    image:
      "https://readdy.ai/api/search-image?query=modern%20luxury%20villa%20exterior%20with%20contemporary%20architecture%2C%20clean%20lines%2C%20large%20windows%2C%20beautiful%20landscaping%2C%20high-end%20residential%20design%2C%20Saudi%20Arabia%20style%2C%20professional%20photography&width=800&height=600&seq=villa-1&orientation=landscape",
  ...
  },
  {
    ...
    duration: "18 أشهر",
    image:
      "https://readdy.ai/api/search-image?query=royal%20palace%20exterior%20with%20traditional%20Arabic%20architecture%2C%20ornate%20details%2C%20grand%20entrance%2C%20luxury%20residential%20design%2C%20majestic%20building%2C%20Saudi%20Arabian%20palace%20style&width=800&height=600&seq=palace-1&orientation=landscape",
    tags: ["تصميم داخلي", "تشطيب", "تصميم خارجي"],
  },
  {
    id: 6,
    ...
    duration: "12 أشهر",
    image:
      "https://readdy.ai/api/search-image?query=modern%20shopping%20mall%20interior%20with%20contemporary%20design%2C%20elegant%20storefronts%2C%20sophisticated%20lighting%2C%20commercial%20retail%20space%2C%20luxury%20shopping%20center%2C%20clean%20architectural%20lines&width=800&height=600&seq=mall-1&orientation=landscape",
    tags: ["تصميم داخلي", "تشطيب", "تصميم خارجي"],
  },
];
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {filteredProjects.map((project, index) => (
        <Link
          ...
          className="group bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden shadow-card-glow hover:shadow-card-glow-hover transform hover:-translate-y-2 transition-all duration-500 cursor-pointer border-2 border-white/20 hover:border-[#CBC1B8]/40 hover:bg-white/20"
          ...
          <div className="p-6 bg-white/5">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {project.tags.length > 2 && (
                <span className="bg-white/10 text-white/80 px-3 py-1 rounded-full text-xs border border-white/20">
                  +{project.tags.length - 2}
                </span>
              )}
            </div>
