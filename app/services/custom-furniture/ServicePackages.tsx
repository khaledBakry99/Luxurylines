  ...
  const packages = [
    {
      ...
      price: '10,000',
      description: 'مثالية لقطعة أثاث واحدة بسيطة',
      features: [
        'استشارة تصميم',
        'قياسات دقيقة',
        'قطعة أثاث واحدة',
    ...
    },
    {
      ...
      price: '25,000',
      description: 'الأكثر طلباً لعدة قطع أثاث',
      features: [
    ...
    },
    {
      name: 'الباقة الشاملة',
      price: '60,000',
      description: 'لتأثيث غرفة كاملة بأثاث مخصص',
      features: [
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-gradient-to-r from-[#F7F6F4] to-[#CBC1B8] text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg whitespace-nowrap">
                    الأكثر طلباً
                  </span>
                </div>
              )}
              ...
              <div className="p-8">
                <div className={`w-16 h-16 bg-gradient-to-br ${pkg.color} rounded-2xl flex items-center justify-center mb-6`}>
                  <i className="ri-home-gear-line text-3xl text-white"></i>
                </div>
