  ...
  const steps = [
    {
      ...
      description: "تحديد المواد المطلوبة والكميات المناسبة بدقة",
      icon: "ri-file-list-3-line",
    },
    {
      number: "02",
      title: "عرض الأسعار",
      description: "تقديم عرض سعر تنافسي وشفاف للمواد المطلوبة",
      icon: "ri-price-tag-3-line",
    },
    {
      number: "03",
      title: "التوريد",
      description: "توريد المواد من مصادر موثوقة وبجودة عالية",
      icon: "ri-truck-line",
    },
    {
      number: "04",
      title: "التسليم",
      description: "تسليم المواد في الموعد المحدد إلى موقع المشروع",
    ...
    <section className="py-20 bg-gradient-to-br from-[#0A1F21] to-[#0F3A3E]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#CBC1B8]/90">
            خطوات بسيطة وواضحة لتوريد جميع احتياجاتك
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div
              key={index}
              className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-2 border border-white/20"
            >
