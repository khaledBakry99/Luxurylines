...
export default function ProductCategories() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-[#0F3A3E] to-[#1C474A] relative">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 w-12 h-12 flex items-center justify-center bg-white/90 backdrop-blur-sm rounded-xl shadow-lg">
                  <i
                    className={`${collection.icon} text-2xl text-[#0A1F21]`}
                  ></i>
                </div>
      ...
      <div className="absolute inset-0 bg-[#0A1F21]/95 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="text-center px-6">
          ...
          <p className="text-xl text-[#CBC1B8] mb-8 max-w-2xl mx-auto">
            نعمل حالياً على تطوير مجموعاتنا الحصرية لتقديم أفضل تجربة تسوق
          </p>
