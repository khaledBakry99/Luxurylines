  ...
  const locations = [
    {
      ...
      address: 'شارع الأمير محمد بن عبدالعزيز، حي الملك فهد، الرياض 12271',
      phone: '+966 11 123 4567',
      email: 'riyadh@luxurylin.com',
      hours: 'السبت - الخميس: 8:00 ص - 6:00 م',
      mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3624.1!2d46.6753!3d24.7136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjTCsDQyJzQ5LjAiTiA0NsKwNDAnMzEuMSJF!5e0!3m2!1sen!2ssa!4v1234567890'
    },
    {
      name: 'فرع جدة',
      address: 'طريق الملك عبدالعزيز، حي الروضة، جدة 23432',
      phone: '+966 12 123 4567',
      email: 'jeddah@luxurylin.com',
      hours: 'السبت - الخميس: 9:00 ص - 7:00 م',
      mapUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3710.1!2d39.1612!3d21.4858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjHCsDI5JzA5LjAiTiAzOcKwMDknNDAuMyJF!5e0!3m2!1sen!2ssa!4v1234567890'
    }
  ];
        ...
        <div className={`transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 shadow-card-glow">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-2 font-['Cairo']">العنوان</h4>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-2 font-['Cairo']">الهاتف</h4>
                      <a 
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-2 font-['Cairo']">البريد الإلكتروني</h4>
                      <a 
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white mb-2 font-['Cairo']">ساعات العمل</h4>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  ...
                  <a
                    href={`https://wa.me/${(locations[activeLocation]?.phone || '').replace(/\s+/g, '').replace('+', '')}`}
              ...
              {/* خدمات إضافية */}
              <div className="bg-gradient-to-r from-[#0A1F21] to-[#0F3A3E] rounded-3xl p-8 text-white border border-[#CBC1B8]/20 shadow-card-glow">
                <h4 className="text-xl font-bold mb-6 font-['Cairo']">خدمات إضافية</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3">
                    <i className="ri-car-fill text-[#CBC1B8]"></i>
                    <span>مواقف مجانية</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <i className="ri-wheelchair-fill text-[#CBC1B8]"></i>
                    <span>مناسب لذوي الاحتياجات</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <i className="ri-wifi-fill text-[#CBC1B8]"></i>
                    <span>واي فاي مجاني</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <i className="ri-cup-fill text-[#CBC1B8]"></i>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <a
                  href={`https://www.google.com/maps/dir//${encodeURIComponent(locations[activeLocation]?.address || '')}`}
                  target="_blank"
          ...
          <div className="bg-gradient-to-r from-[#1C474A] to-[#0A2F33] rounded-3xl p-8 md:p-10 relative overflow-hidden shadow-[#1C474A]/40 border border-[#CBC1B8]/10 mt-16">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-[#CBC1B8]/90 mb-6 max-w-2xl mx-auto leading-relaxed">
                احجز موعداً مسبقاً لضمان توفر الوقت المناسب لك ولتلقي خدمة شخصية مميزة
              </p>
