  ...
  const steps = [
    {
      ...
      description: 'نبدأ بفهم احتياجاتك ورؤيتك من خلال جلسة استشارة مفصلة ووضع خطة شاملة للمشروع',
      icon: 'ri-lightbulb-line',
      color: 'from-[#0A1F21] to-[#0F3A3E]',
      features: ['تحليل المتطلبات', 'وضع الميزانية', 'الجدول الزمني', 'التصميم الأولي']
    },
    {
      id: 2,
      title: 'التصميم والتطوير',
      description: 'نقوم بتطوير التصاميم التفصيلية والرسومات الهندسية مع استخدام أحدث التقنيات',
      icon: 'ri-pencil-ruler-2-line',
      color: 'from-[#0A2F33] to-[#1C474A]',
      features: ['التصميم ثلاثي الأبعاد', 'اختيار المواد', 'الرسومات التنفيذية', 'المراجعة والتعديل']
    },
    {
      id: 3,
      title: 'التنفيذ والإشراف',
      description: 'نبدأ تنفيذ المشروع مع إشراف مستمر من فريق الخبراء لضمان أعلى معايير الجودة',
      icon: 'ri-hammer-line',
      color: 'from-[#0F3A3E] to-[#0A2F33]',
      features: ['إدارة الموقع', 'مراقبة الجودة', 'التنسيق مع المقاولين', 'التقارير الدورية']
    },
    {
      id: 4,
      title: 'التسليم والمتابعة',
      description: 'نسلم المشروع مكتملاً مع ضمان الجودة وخدمة ما بعد التسليم لضمان رضاكم التام',
      icon: 'ri-check-double-line',
      color: 'from-[#0F3A3E] to-[#1C474A]',
      features: ['الفحص النهائي', 'التسليم الرسمي', 'ضمان الجودة', 'الصيانة الدورية']
    }
  ];
    ...
    <section className="py-20 bg-gradient-to-br from-[#0A1F21] to-[#0F3A3E] relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full opacity-10">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#CBC1B8]/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              {/* البطاقة */}
              <div className={`relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-500 ${
            ...
            {steps.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${
                  activeStep === index ? 'bg-[#CBC1B8] scale-125' : 'bg-white/30 hover:bg-white/50'
                }`}
              />
            ))}
          </div>
        ...
        {/* إحصائيات */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`} style={{ animationDelay: '800ms' }}>
          {[
