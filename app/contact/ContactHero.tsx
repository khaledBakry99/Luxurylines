    ...
    <section className="relative min-h-screen bg-gradient-to-br from-[#0A1F21] via-[#0F3A3E] to-[#0A1F21] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-[#CBC1B8]/20 to-transparent animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 font-['Cairo'] leading-tight">
              ...
              <span className="block text-[#CBC1B8]">
                اليوم
              </span>
              <span className="block text-white/90 text-3xl md:text-4xl mt-6">ولنبدأ رحلة الإبداع</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-white/90 mb-12 leading-relaxed max-w-4xl mx-auto">
              نحن هنا لتحويل أحلامك إلى واقع معماري استثنائي. تواصل معنا اليوم واحصل على نصائح مجانية 
              من فريق الخبراء لمشروعك القادم وابدأ رحلة التميز معنا
            </p>
          </div>

          {/* طرق التواصل السريع - تصميم جديد */}
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            {[
              { 
                icon: 'ri-phone-line', 
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center bg-gradient-to-br from-[#CBC1B8]/20 to-[#F7F6F4]/20 rounded-2xl border border-[#CBC1B8]/30 group-hover:border-[#CBC1B8]/60 group-hover:shadow-lg group-hover:shadow-[#CBC1B8]/30 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110">
                    <i className={`${contact.icon} text-4xl text-[#CBC1B8] group-hover:scale-110 transition-transform duration-300`}></i>
                  </div>
                ...
                <div className="absolute top-4 right-4 w-2 h-2 bg-[#CBC1B8]/40 rounded-full group-hover:animate-ping" style={{animationDelay: '0.2s'}}></div>
              </a>
            ))}
          </div>

          {/* أزرار التواصل السريع */}
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <a 
