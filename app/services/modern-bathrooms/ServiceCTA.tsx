...
export default function ServiceCTA() {
  return (
    <section className="py-20 bg-gradient-to-br from-[#0A1F21] via-[#0F3A3E] to-[#1C474A] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mx-auto mb-8">
            <i className="ri-drop-line text-5xl text-white"></i>
          </div>
          
          <h2 className="text-4xl md:text-6xl font-['Cairo'] font-bold mb-6">
            هل أنت مستعد لحمام أحلامك؟
          </h2>
          
          <p className="text-xl md:text-2xl mb-12 text-white/90 leading-relaxed">
            دعنا نساعدك في تصميم وتنفيذ حمام عصري فاخر بأفضل التجهيزات
          </p>
