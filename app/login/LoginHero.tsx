          ...
          <div className="text-center mb-8">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-[#CBC1B8] to-[#F7F6F4] rounded-2xl flex items-center justify-center shadow-2xl">
                <span className="text-[#0A1F21] font-bold text-2xl font-['Pacifico']">
                  L
                </span>
              </div>
            </Link>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-card-glow p-8 border border-white/20">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-[#CBC1B8] border-white/30 rounded focus:ring-[#CBC1B8] cursor-pointer bg-white/10"
                  />
                  <span className="mr-2 text-sm text-white/80">تذكرني</span>
                </label>
                <Link
                  href="/forgot-password"
                  className="text-sm text-[#CBC1B8] hover:text-white font-semibold cursor-pointer"
                >
                  نسيت كلمة المرور؟
                </Link>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-white/70">
                ...
                <Link
                  href="/signup"
                  className="text-[#CBC1B8] hover:text-white font-semibold cursor-pointer"
                >
                  سجل الآن
                </Link>
              </p>
