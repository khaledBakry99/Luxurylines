...
export default function ServicePackages() {
  const packages = [
    ...
    },
    {
      name: 'الباقة الفاخرة',
      price: '80,000',
      description: 'للحمامات الفاخرة بتصميم سبا',
      features: [
        'كل مميزات الباقة المتقدمة',
        'أدوات صحية عالمية',
        'رخام فاخر',
        'جاكوزي أو بانيو فاخر',
        'نظام صوتي',
        'إضاءة ذكية',
        'تصميم سبا كامل',
        'ضمان 5 سنوات'
            ...
            >
              {pkg.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-gradient-to-r from-[#1C474A] to-[#0F3A3E] text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg whitespace-nowrap">
                    الأكثر طلباً
                  </span>
                </div>
              )}
