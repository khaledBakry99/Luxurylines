...
export default function CartItems() {
  ...
  const [cartItems, setCartItems] = useState<CartItem[]>([
    {
      ...
      quantity: 1,
      image:
        "https://readdy.ai/api/search-image?query=modern%20living%20room%20furniture%20set%20with%20sofa%20and%20coffee%20table%20in%20neutral%20colors%2C%20clean%20background%2C%20professional%20product%20photography&width=300&height=200&seq=cart1&orientation=landscape",
      category: "أثاث",
      discount: 10,
      inStock: true,
      status: "completed",
    ...
    },
    {
      ...
      quantity: 2,
      image:
        "https://readdy.ai/api/search-image?query=modern%20floor%20lamp%20with%20sleek%20design%2C%20minimalist%20style%2C%20white%20background%2C%20product%20photography&width=300&height=200&seq=cart2&orientation=landscape",
      category: "إضاءة",
      inStock: true,
      status: "pending",
    ...
    },
    {
      ...
      quantity: 1,
      image:
        "https://readdy.ai/api/search-image?query=luxury%20decorative%20carpet%20with%20elegant%20patterns%2C%20high%20quality%20texture%2C%20neutral%20background%2C%20product%20photography&width=300&height=200&seq=cart3&orientation=landscape",
      category: "ديكور",
      discount: 15,
      inStock: true,
      status: "in-progress",
  ...
  if (cartItems.length === 0) {
    return (
      <div className="bg-[#F7F6F4] rounded-3xl shadow-2xl p-16 text-center transform hover:scale-[1.02] transition-all duration-500 border border-[#CBC1B8]/20">
        <div className="w-32 h-32 mx-auto mb-8 flex items-center justify-center bg-gradient-to-br from-[#CBC1B8] to-[#F7F6F4] rounded-3xl shadow-lg">
          <i className="ri-shopping-cart-line text-6xl text-[#0A1F21]"></i>
        </div>
        <h3 className="text-3xl font-bold text-[#0A1F21] mb-4">السلة فارغة</h3>
        <p className="text-[#0A1F21]/70 mb-10 text-lg max-w-md mx-auto">
          لم تقم بإضافة أي منتجات أو خدمات إلى السلة بعد
        </p>
        <Link href="/store/shop">
          <button className="bg-gradient-to-r from-[#CBC1B8] to-[#F7F6F4] text-[#0A1F21] px-10 py-5 rounded-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 whitespace-nowrap cursor-pointer font-bold text-lg">
  ...
  return (
    <>
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-[#F7F6F4] to-[#CBC1B8]/20 rounded-3xl shadow-xl overflow-hidden border border-[#CBC1B8]/20">
          <div className="bg-gradient-to-r from-[#0A1F21] via-[#1C474A] to-[#0A1F21] p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-3xl font-bold text-white mb-3 flex items-center gap-3">
                  <div className="w-12 h-12 bg-[#CBC1B8]/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                    <i className="ri-shopping-bag-3-line text-2xl text-white"></i>
                  </div>
                  <span>سلة التسوق والطلبات</span>
                </h2>
                <p className="text-[#CBC1B8] flex items-center gap-2 mr-16">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className={`px-6 py-3 rounded-2xl font-bold transition-all duration-300 cursor-pointer whitespace-nowrap text-sm ${
                  activeFilter === "all"
                    ? "bg-[#CBC1B8] text-[#0A1F21] shadow-xl scale-105"
                    : "bg-[#CBC1B8]/10 text-white border-2 border-[#CBC1B8]/20 hover:bg-[#CBC1B8]/20 hover:border-[#CBC1B8]/40"
                }`}
              >
                      ...
                      <div className="flex items-start justify-between gap-4 mb-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-3">
                            <span
                              className={`px-4 py-2 rounded-xl text-sm font-bold border-2 flex items-center gap-2 ${getStatusColor(
                                item.status
                              )}`}
                            >
                              <i
                        ...
                        {item.discount ? (
                          <>
                            <p className="text-3xl font-bold text-[#FFA500]">
                              {calculateItemPrice(item).toFixed(2)} ر.س
                            </p>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      {item.type === "product" && item.productLink ? (
                        <Link href={item.productLink} className="flex-1">
                          <button className="w-full bg-gradient-to-r from-[#CBC1B8] to-[#F7F6F4] text-[#0A1F21] py-4 px-8 rounded-2xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer whitespace-nowrap">
                        ...
                        <Link href="/contact" className="flex-1">
                          <button className="w-full bg-gradient-to-r from-[#0A1F21] to-[#1C474A] text-white py-4 px-8 rounded-2xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer whitespace-nowrap">
                            <span className="flex items-center justify-center gap-2">
                      ...
                      <button
                        ...
                        className="px-8 py-4 bg-white border-2 border-[#CBC1B8] text-[#0A1F21] rounded-2xl font-bold hover:bg-[#CBC1B8] hover:text-[#0A1F21] hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer whitespace-nowrap"
                      >
                        <span className="flex items-center gap-2">
        ...
        {filteredItems.length === 0 && (
          <div className="bg-white rounded-3xl shadow-xl p-16 text-center border border-gray-100">
            ...
            <h3 className="text-3xl font-bold text-[#001F3F] mb-4">
              لا توجد عناصر
            </h3>
            ...
            <div className="p-10" id="invoice-content">
              <div className="flex items-center justify-between mb-10 pb-8 border-b-2 border-gray-200">
                <div className="flex items-center space-x-5 space-x-reverse">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#FFA500] to-[#ff8c00] rounded-2xl flex items-center justify-center shadow-xl">
                    <span className="text-white font-bold text-4xl font-['Pacifico']">
                      L
                    </span>
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold font-['Pacifico'] text-[#001F3F]">
                      Luxurylines
                    </h2>
                      ...
                      {selectedOrder.progress && (
                        <div className="mb-3">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs font-bold text-[#FFA500]">
                              {selectedOrder.progress}%
                            </span>
                          </div>
              ...
              <div className="bg-gradient-to-r from-[#001F3F] to-[#003366] rounded-2xl p-8 text-center text-white">
                ...
                <p className="text-sm opacity-90">
                  نسعد بخدمتكم دائماً في Luxurylines
                </p>
              </div>
            </div>
