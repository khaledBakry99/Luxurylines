...
const projects = [
  ...
  },
  {
    ...
    category: "painting",
    image:
      "https://readdy.ai/api/search-image?query=modern%20kitchen%20plumbing%20installation%20with%20elegant%20sink%20and%20faucet%2C%20sophisticated%20water%20system%2C%20premium%20quality%20fixtures%2C%20professional%20installation%20work%2C%20contemporary%20kitchen%20design%20with%20beautiful%20plumbing%20finish&width=600&height=800&seq=finishing5&orientation=portrait",
    title: "الدهانات",
    description: "دهانات عالية الجودة",
  },
  {
    id: 6,
    category: "flooring",
    image:
      "https://readdy.ai/api/search-image?query=sophisticated%20home%20automation%20electrical%20system%20with%20smart%20lighting%20controls%2C%20modern%20electrical%20panel%2C%20elegant%20switches%20and%20outlets%2C%20professional%20wiring%20installation%2C%20contemporary%20smart%20home%20technology%2C%20high-quality%20electrical%20components&width=600&height=800&seq=finishing6&orientation=portrait",
    title: "الأرضيات",
    description: "أرضيات فاخرة ومتينة",
  },
  {
    id: 7,
    category: "plumbing",
    image:
      "https://readdy.ai/api/search-image?query=luxury%20ceiling%20design%20installation%20with%20elegant%20gypsum%20board%2C%20sophisticated%20lighting%20integration%2C%20modern%20false%20ceiling%20work%2C%20professional%20craftsmanship%2C%20contemporary%20interior%20design&width=600&height=800&seq=finishing7&orientation=portrait",
    title: "الأسقف",
    description: "أسقف معلقة وجبس بورد",
  },
  {
    id: 8,
    category: "electrical",
    image:
      "https://readdy.ai/api/search-image?query=elegant%20interior%20finishing%20details%20with%20premium%20moldings%2C%20sophisticated%20trim%20work%2C%20modern%20door%20frames%2C%20professional%20carpentry%2C%20high-end%20residential%20finishing&width=600&height=800&seq=finishing8&orientation=portrait",
    title: "التفاصيل النهائية",
    description: "لمسات نهائية احترافية",
  },
];
...
export default function ServiceGallery() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-[#0F3A3E] to-[#1C474A]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 bg-[#CBC1B8]/15 px-6 py-3 rounded-full mb-6">
            ...
            <span className="text-[#F7F6F4]/85 font-medium">معرض الأعمال</span>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map((category) => (
            <button
              ...
              className={`px-8 py-3 rounded-full font-['Cairo'] font-semibold transition-all duration-300 whitespace-nowrap ${
                activeCategory === category.id
                  ? "bg-gradient-to-r from-[#CBC1B8] to-[#F7F6F4] text-[#0A1F21] shadow-lg scale-105"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={project.id}
              className="group bg-gradient-to-br from-[#1C474A] to-[#0A1F21] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 cursor-pointer border border-[#CBC1B8]/20"
            ...
            >
              <div className="relative h-96 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  ...
                  <p className="text-[#CBC1B8]/90 mb-4">
                    {project.description}
                  </p>
