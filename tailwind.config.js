  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(to bottom right, #0A1F21, #1C474A, #0F3A3E)',
        'services-gradient': 'linear-gradient(to right, #0F3A3E, #1C474A)',
        'projects-gradient': 'linear-gradient(to bottom, #1C474A, #0F3A3E, #0A1F21)',
        'testimonials-gradient': 'linear-gradient(to bottom right, #0A2F33, #0A1F21)',
